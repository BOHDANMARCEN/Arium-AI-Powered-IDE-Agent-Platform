...
const wsRateLimiterInterval = setInterval(() => wsRateLimiter.cleanup(), 5 * 60 * 1000);
wsRateLimiterInterval.unref?.();

export function shutdownWsRateLimiter(): void {
  clearInterval(wsRateLimiterInterval);
}
