...
export class DocumentationGenerator {
  ...
  private analyzeClass(classDeclaration: any, filePath: string): DocumentationItem {
    ...
    return {
      ...
      private: classDeclaration.isPrivate ? classDeclaration.isPrivate() : false,
    };
  }
  ...
  private analyzeProperty(property: any): PropertyDoc {
    ...
    return {
      ...
      description: jsDoc?.description,
      optional: property.hasQuestionToken ? property.hasQuestionToken() : false,
      readonly: property.isReadonly ? property.isReadonly() : false,
    };
  }
  ...
  private shouldIncludeDeclaration(declaration: any): boolean {
    if (!this.options.includePrivate && (declaration.isPrivate ? declaration.isPrivate() : false)) {
      return false;
    }
